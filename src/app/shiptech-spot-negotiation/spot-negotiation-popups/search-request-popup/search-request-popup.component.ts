...
export class SearchRequestPopupComponent implements OnInit {
  ...
  public columnDefs = [
        ...
        { 
            headerName: 'Request Status', headerTooltip: 'Request Status', field: 'request_status', suppressMenu: true,
            ...
            var classArray:string[] =[]; 
                ...
                let newClass= params.value==='Validated'?'custom-chip medium-amber':
                            'custom-chip dark';
                            classArray.push(newClass);
                return {cellClass: classArray.length>0?classArray:null} }},
        { 
            headerName: 'OPS Validation', headerTooltip: 'OPS Validation', field: 'ops_validation', suppressMenu: true,
            cellRendererFramework:AGGridCellRendererComponent, cellClass: ['aggridtextalign-center'],
            cellRendererParams: function(params) { 
            var classArray:string[] =[]; 
                classArray.push('aggridtextalign-center');
                let newClass= params.value==='No'?'custom-chip medium-red':
                            'custom-chip dark';
                            classArray.push(newClass);
                return {cellClass: classArray.length>0?classArray:null} }},
        {
  ...
  private rowData = [
    {
        id: '112837', date: '12/10/2020 10:30', service: 'SALONIXP', buyer: 'Saida Moleu', vessel: 'A La Marine', imo: '09827822',
        eta: '12/10/2020 10:30', location: 'Rotterdam', request_status: 'Validated', ops_validation: 'No', product: 'RMG 380'
    },
    {
        id: '112837', date: '12/10/2020 10:30', service: 'SALONIXP', buyer: 'Saida Moleu', vessel: 'A La Marine', imo: '09827822',
        eta: '12/10/2020 10:30', location: 'Rotterdam', request_status: 'Validated', ops_validation: 'No', product: 'RMG 380'
