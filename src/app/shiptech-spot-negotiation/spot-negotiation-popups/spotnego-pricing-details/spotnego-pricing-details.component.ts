...
export class SpotnegoPricingDetailsComponent implements OnInit {
  ...
  constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer,public dialog: MatDialog, public dialogRef: MatDialogRef<SpotnegoPricingDetailsComponent>,    @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  searchFormula(){
    ...
    // this.formulaValue = "Draft MOPS 380 cst 3.5% (PPX DK 00) ";
