...
export class SpotnegoemaillogComponent implements OnInit {
  ...
  private columnDef_grid = [
    ...
    { headerName: 'Mail sent to', headerTooltip: 'Mail Sent to', tooltip: (params) => params.value, field: 'mailsentto',width:345,suppressSizeToFit: false },
    { headerName: 'Status', headerTooltip: 'Status', field: 'status',width:345,suppressSizeToFit: false , headerClass:['aggrid-text-align-c'], cellClass: ['aggridtextalign-center'],
    cellClassRules: this.statusBGRules },
    { headerName: 'Sender', headerTooltip: 'Sender', tooltip: (params) => params.value, field: 'sender',width:345, suppressSizeToFit: false  },
    { headerName: 'Subject', headerTooltip: 'Subject', tooltip: (params) => params.value, field: 'subject',width:345 ,suppressSizeToFit: false },
    { headerName: 'Mail Date', headerTooltip: 'Mail Date', field: 'maildate', tooltip: (params) => params.value, suppressSizeToFit: false },
  ...
  private rowData_grid = [
    ...
    { mailsentto:'alexanderj@inatech.com',status:'Success',sender:'alexanderj@inatech.com',subject:'Contract',maildate:'12/10/2020 10:30'
      ...
      { mailsentto:'alexanderj@inatech.com',status:'Pending',sender:'alexanderj@inatech.com',subject:'Contract',maildate:'12/10/2020 10:30'
    },
    { mailsentto:'alexanderj@inatech.com',status:'Failed',sender:'alexanderj@inatech.com',subject:'Contract',maildate:'12/10/2020 10:30'
  },
  { mailsentto:'alexanderj@inatech.com',status:'Success',sender:'alexanderj@inatech.com',subject:'Contract',maildate:'12/10/2020 10:30'
},
{ mailsentto:'alexanderj@inatech.com',status:'Success',sender:'alexanderj@inatech.com',subject:'Contract',maildate:'12/10/2020 10:30'
