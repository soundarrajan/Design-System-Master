...
@Component({
  selector: 'app-verified-other-movements',
  templateUrl: './verified-other-movements.component.html',
  styleUrls: ['./verified-other-movements.component.scss']
})
export class VerifiedOtherMovementsComponent implements OnInit {
  ...
  private columnDefs = [
    ...
    { headerName: 'Price', headerTooltip: 'Price', field: 'price', type: "numericColumn", cellClass: [' aggrid-editable aggridtextalign-right'] },
    { headerName: 'Currency', headerClass: 'p-l-0', headerTooltip: 'Currency', field: 'currency', cellClass: ['aggrid-editable aggridtextalign-left'] },
    {
  ...
  private rowData = [
    {
      movementid: 'MOV7264826', price: '0', currency: '_____', revert: 'yes', oppmovid: 'MOV7264826', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
    {
      movementid: 'MOV7264826', price: '0', currency: '_____', revert: 'yes', oppmovid: 'MOV7264826', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
    {
      movementid: 'MOV7264826', price: '0', currency: '_____', revert: 'no', oppmovid: 'MOV7264826', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
    {
      movementid: 'MOV7264826', price: '0', currency: '_____', revert: 'NO', oppmovid: 'MOV7264826', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
