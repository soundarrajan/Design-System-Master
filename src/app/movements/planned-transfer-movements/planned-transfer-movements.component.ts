...
@Component({
  selector: 'app-planned-transfer-movements',
  templateUrl: './planned-transfer-movements.component.html',
  styleUrls: ['./planned-transfer-movements.component.scss']
})
export class PlannedTransferMovementsComponent implements OnInit {
  ...
  private columnDefs = [
    ...
    { headerName: 'Cl', headerTooltip: 'Cl', field: 'cl', cellClass: ['aggrid-editable aggrid-editable-onselect aggridtextalign-right'], type: "numericColumn" },
    ...
    // {headerName: 'Qty Conversion', field: '', headerTooltip : 'Qty Conversion', type: "numericColumn", 
    // cellClass:["aggrid-content-center"], cellRendererFramework:AGGridCellDataComponent, cellRendererParams:{type:'checkbox-popup'},
    // pinned:'right',width:90},
  ...
  private rowData = [
    {
      movementid: 'MOV7264826', oppmovid: 'MOV7264826', revert: 'yes', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
    {
      movementid: 'MOV7264826', oppmovid: 'MOV7264826', revert: 'yes', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
    ...
    {
      movementid: 'MOV7264826', oppmovid: 'MOV7264826', movtype: 'Transfer In', revert: 'yes', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
