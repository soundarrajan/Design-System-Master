...
@Component({
  selector: 'app-viewcosting-transfer-movements',
  templateUrl: './viewcosting-transfer-movements.component.html',
  styleUrls: ['./viewcosting-transfer-movements.component.css']
})
export class ViewcostingTransferMovementsComponent implements OnInit {
    ...
    this.gridOptions_transOut = <GridOptions>{
      ...
      onGridReady: (params) => {
        ...
        params.api.setPinnedBottomRowData([
          { delivery_no: 'Per Unit COGS', per_unit: "1000.0000" }
        ]);
      },
