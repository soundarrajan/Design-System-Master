...
@Component({
  selector: 'app-closed-other-movements',
  templateUrl: './closed-other-movements.component.html',
  styleUrls: ['./closed-other-movements.component.scss']
})
export class ClosedOtherMovementsComponent implements OnInit {
