...
@Component({
  selector: 'app-verified-transfer-movements',
  templateUrl: './verified-transfer-movements.component.html',
  styleUrls: ['./verified-transfer-movements.component.scss']
})
export class VerifiedTransferMovementsComponent implements OnInit {
  ...
  private columnDefs = [

    {
      ...
      pinned: 'left',
      width: 120,
      cellRendererParams: { type: 'cell-hover-click-menu-2dv' }
    },
  ...
  private rowData = [
    {
      movementid: 'MOV7264826', revert: 'yes', oppmovid: 'MOV7264826', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
    {
      movementid: 'MOV7264826', revert: 'yes', oppmovid: 'MOV7264826', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
    {
      movementid: 'MOV7264826', revert: 'no', oppmovid: 'MOV7264826', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
    {
      movementid: 'MOV7264826', revert: 'NO', oppmovid: 'MOV7264826', movtype: 'Transfer In', product: 'Diesel Fuel', movementdate: '29 - Jan - 2020 17:32', tank: 'Tank1', intankproduct: 'Disel Fuel', massqty: '10000', massuom: 'BBlS', volumeqty: '10000', volumeuom: 'BBLS', referenceno: 'REF1123820876', cl: '01.00', blendrefno: 'BL683910', sourcedocument: 'BL'
    },
