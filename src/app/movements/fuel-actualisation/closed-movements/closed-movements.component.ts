...
@Component({
  selector: 'app-closed-movements',
  templateUrl: './closed-movements.component.html',
  styleUrls: ['./closed-movements.component.scss']
})
export class ClosedMovementsComponent implements OnInit {
  ...
  private columnDefs = [
...

    {
      ...
      pinned: 'left',
      width: 120,
      cellRendererParams: { type: 'cell-hover-click-menu-ova' }
    },
  ...
  private rowData = [
    {
      deliveryid: 'PS001-1', bol_no: 'Diesel Fuel', status: 'Sell', product: 'In', movementid: 'MOV7264826', pipeline: 'Tank1', delivery_date: '1000', counterparty: '29 - Jan - 2020 17:32', strategy: 'Hedging', company: 'Demo Composition', quantity: 'Diesel Fuel',
    ...
    {
      deliveryid: 'PS001-1', bol_no: 'Diesel Fuel', status: 'Sell', product: 'B2B Out', movementid: 'MOV7264826', pipeline: 'Tank1', delivery_date: '1000', counterparty: '29 - Jan - 2020 17:32', strategy: 'Hedging', company: 'Demo Composition', quantity: 'Diesel Fuel',
    ...
    {
      deliveryid: 'PS001-1', bol_no: 'Diesel Fuel', status: 'Sell', product: 'Out', movementid: 'MOV7264826', pipeline: 'Tank1', delivery_date: '1000', counterparty: '29 - Jan - 2020 17:32', strategy: 'Hedging', company: 'Demo Composition', quantity: 'Diesel Fuel',
    ...
    {
      deliveryid: 'PS001-1', bol_no: 'Diesel Fuel', status: 'Sell', product: 'B2B In', movementid: 'MOV7264826', pipeline: 'N/A', delivery_date: '1000', counterparty: '29 - Jan - 2020 17:32', strategy: 'Hedging', company: 'Demo Composition', quantity: 'Diesel Fuel',
