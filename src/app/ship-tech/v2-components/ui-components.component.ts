...
import { ModalPopUpComponent } from '../../shared/designsystem-v2/modal-pop-up/modal-pop-up.component'
...
export class UiComponentsComponent implements OnInit {
  ...
  types = [
    ...
    { value: 'inputwithautocomplete', viewValue: 'Input with Auto Complete' },
  ...
  public badgeitemsDropdown = [
    { label: "Buyer's Using", value: ["Confirm", "Vessel", "BDN"] },
    { label: "Seller's Using", value: ["Confirm", "Vessel", "BDN"] },
    { label: "Confirm Qty", value: ["1.00 MT"] },
    { label: "BDN Qty", value: ["1.00 MT"] },
    { label: "QTY Variance", value: ["1.00 MT"] }
  ];
  customTabData = [
  ...
  viewSourceCode() {
    //alert(this.componentDetails.key);
    this.showCode = !this.showCode;
  ...
  openDialog1() {
    let data = {
      "lightTheme":true,
      "title": "Preview of Popup Modal 1",
      "searchBox": {
        "display": true
      },
      "actionButtons": [
        { "btnName": "Revert", "display": false },
        { "btnName": "Save", "display": true },
        { "btnName": "Save & Send", "display": false }
      ],
      "displayClose": true,
      "displayContentBorder": true,
      "showFooter": false
    };
    const dialogRef = this.dialog.open(ModalPopUpComponent, {

      panelClass: 'popup-modal-component',
      data: { data: data, component: PopupContent1Component },
  ...
  openDialog2() {
    let data = {
      "lightTheme":false,
      "title": "Preview of Popup Modal 2",
      "searchBox": {
        "display": true
      },
      "actionButtons": [
        { "btnName": "Revert", "display": true },
        { "btnName": "Save", "display": true },
        { "btnName": "Save & Send", "display": true }
      ],
      "displayClose": true,
      "displayContentBorder": true,
      "showFooter": false
    ...
    const dialogRef = this.dialog.open(ModalPopUpComponent, {
      ...
      panelClass: 'popup-modal-component',
      data: { data: data, component: PopupContent2Component },
...
@Component({
  selector: "popup-content1",
  template: `
    <div>Sample Rendering Component 1</div>
  `
})
export class PopupContent1Component { }

@Component({
  selector: "popup-content2",
  template: `
    <div>Sample Rendering Component 2</div>
  `
})
export class PopupContent2Component { }
