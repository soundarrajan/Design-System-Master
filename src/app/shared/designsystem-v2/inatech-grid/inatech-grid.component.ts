...
export class InatechGridComponent implements OnInit {
  ...
  addcolmn(){
    if(!this.isExpand){
      ...
      this.coln.splice(10,0, 'MJ/KJ');
      console.log("after splice " + this.coln);
      this.coln.splice(11,0, 'TCO ($)');
      this.coln.splice(12,0, 'E. diff');
      this.pg1_col_span=8;     

      this.coln.splice(18,0, 'MJ/KJ');
      this.coln.splice(19,0, 'TCO ($)');
      this.coln.splice(20,0, 'E. diff');
      this.pg2_col_span=8;

      this.coln.splice(26,0, 'MJ/KJ');
      this.coln.splice(27,0, 'TCO ($)');
      
      this.coln.splice(28,0, 'E. diff');
      this.pg3_col_span=8;
      console.log("after splice " + this.coln);
