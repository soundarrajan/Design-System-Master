...
export class FrameworkLibraryService {
  ...
  constructor(@Inject(Framework) private frameworks: any[], @Inject(WidgetLibraryService) private widgetLibrary: WidgetLibraryService) {
  ...
  public setFramework(framework: string | Framework = this.defaultFramework, loadExternalAssets = this.loadExternalAssets): boolean {
  ...
  registerFrameworkWidgets(framework: Framework): boolean {
    return hasOwn(framework, 'widgets') ? this.widgetLibrary.registerFrameworkWidgets(framework.widgets) : this.widgetLibrary.unRegisterFrameworkWidgets();
  }
