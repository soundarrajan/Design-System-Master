...
@Component({
    ...
    template: `<mat-chip-list> <mat-chip color="accent" matTooltip="{{toolTip}}" [ngClass]="{'aggrid-roundchip': params.type=='round', 'chipbase': params.color=='chipbase','darkgreen':  params.color=='darkgreen'}" 
    class="text-center aggrid-custom-chip chipbase mat-chip mat-primary mat-standard-chip" (click)=showICDetails()>{{this.params.value}} </mat-chip></mat-chip-list>`
})
