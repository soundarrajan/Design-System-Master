...
@Component({
    ...
    template: `
        <div #container tabindex="0" (keydown)="onKeyDown($event)" (click)="$event.stopPropagation();">
...
export class AGGridEditorComponent implements ICellEditorAngularComp, AfterViewInit {
    private params: any;
