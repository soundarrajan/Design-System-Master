...
export class reconciliationHomeComponent implements OnInit {
...
private columnDefs = [
  
  {
    ...
    cellRendererFramework:AGGridCellDataComponent,
     cellClass: ['aggridlink text-ellipsis product-cell'], 
     pinned:'left', 
     width: 120,
     cellRendererParams: {type:'operation-summary-popup'}},
    ...
    {headerName: 'Provisional Invoice Raised', field: 'invoice', headerTooltip : 'Provisional Invoice raised', headerClass:['aggrid-text-align-l'], cellClass: ['aggrid-text-align-l'], type: "numericColumn"},
    ...
    {headerName: 'LCFS Actual Date', field: 'delivery_date', headerTooltip : 'LCFS Actual date', cellClass: ['aggridtextalign-center'],headerClass:['aggrid-text-align-c'],
        cellRendererFramework:AGGridCellRendererComponent, cellRendererParams: {cellClass: ['custom-chip dark']}},   
    { headerName: 'Reverts', headerTooltip:'Revert', field: '', 
