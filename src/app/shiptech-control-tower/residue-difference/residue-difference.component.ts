...
rowSelection: 'single',
  ...
  private columnDef_aggrid = [
    {
      headerName: 'Port Call', headerTooltip: 'Port Call', field: 'portCall',width:120,cellStyle: { 'padding-left': '15px' }
     },
     {
     ...
     {
      headerName: 'Product Type', headerTooltip: 'Product Type', field: 'type',width:120
     },
     {
     ...
     {
      headerName: 'Difference', headerTooltip: 'Difference', field: 'diff',width:120
     },
     {
    ...
    { headerName: 'Progress', headerClass: ['aggrid-text-align-c'],cellClass: ['status aggridtextalign-center'],headerTooltip: 'Progress', field: 'status',width:150,
    cellRendererFramework: AGGridCellRendererComponent,
    cellRendererParams: function(params) { 
      var classArray:string[] =[]; 
        classArray.push('aggridtextalign-center');
  ...
  public rowData_aggrid = [
    { portCall:'000050001536482',vessel:'CMA CGM A Lincoln',port:'Algeciras',type:'HSFO',logQty:'1295.930',mQty:'1350.647',
    diff:'-54.717',uom:'MT',date:'Fri 11/02/2021 05:30',qtystatus:'Unmatched',status:'New',actions:''
    },
    { portCall:'000050001536482',vessel:'Aila',port:'Algeciras',type:'HSFO',logQty:'1295.930',mQty:'1350.647',
    diff:'-54.717',uom:'MT',date:'Fri 11/02/2021 05:30',qtystatus:'Matched',status:'Marked as Seen',actions:''
    },
    { portCall:'000050001536482',vessel:'Aila',port:'Algeciras',type:'HSFO',logQty:'1295.930',mQty:'1350.647',
    diff:'-54.717',uom:'MT',date:'Fri 11/02/2021 05:30',qtystatus:'Matched',status:'Resolved',actions:''
    },
    { portCall:'000050001536482',vessel:'CMA CGM A Lincoln',port:'Algeciras',type:'HSFO',logQty:'1295.930',mQty:'1350.647',
    diff:'-54.717',uom:'MT',date:'Fri 11/02/2021 05:30',qtystatus:'Unmatched',status:'New',actions:''
    },
  ...
  private columnDef_aggrid1 = [
    {
     ...
     {
      headerName: 'BDN Qty', headerTooltip: 'BDN Qty', field: 'logQty',width:120
     },
     {
      headerName: 'Meaured Delivered Quantity / Survey Report Value', headerTooltip: 'Meaured Delivered Quantity / Survey Report Value', field: 'mQty',width:120
     },
     {
      headerName: 'Difference', headerTooltip: 'Difference', field: 'diff',width:120
     },
    ...
    { headerName: 'Status', headerClass: ['aggrid-text-align-c'],cellClass: ['status aggridtextalign-center'],headerTooltip: 'Status', field: 'status',width:150,
    cellRendererFramework: AGGridCellRendererComponent,
    cellRendererParams: function(params) { 
      var classArray:string[] =[]; 
        classArray.push('aggridtextalign-center');
  ...
  selectedTabChange(e: MatTabChangeEvent){
    //console.log(e);
    if(e.index == 0)
    this.gridTitle="Sludge Difference";

    if(e.index == 1)
    this.gridTitle="EGCS Product Difference";
