...
export class ResidueClaimsComponent implements OnInit {
  ...
  tabChange(){
    ...
    private columnDef_aggrid = [
     {
        headerName: 'Order No.', headerTooltip: 'Order No.', field: 'orderNo',width:120,cellStyle: { 'padding-left': '15px' }
      },
      {
        headerName: 'Delivery No.', headerTooltip: 'Delivery No.', field: 'deliveryNo',  width:120
      },
      {
        headerName: 'Claim No. ', headerTooltip: 'Claim No. ', field: 'claimNo',  width:120
      },
      {
      ...
      { headerName: 'Claim Status', headerClass: ['aggrid-text-align-c'],cellClass: ['status aggridtextalign-center'],headerTooltip: 'Claim Status', field: 'status',width:150,
    ...
    public rowData_aggrid = [
      ...
      { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
      seller:'Repsol Petroleo',shortage:'1300.000',uom:'MT',status:'Marked as Seen',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
      },
      { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
      seller:'Repsol Petroleo',shortage:'1300.000',uom:'MT',status:'New',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
      },
      ...
      { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
      seller:'Repsol Petroleo',shortage:'1300.000',uom:'MT',status:'Off Spec',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
      },
      { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
      seller:'Repsol Petroleo',shortage:'1300.000',uom:'MT',status:'Resolved',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
      },
      { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
      seller:'Repsol Petroleo',shortage:'1300.000',uom:'MT',status:'Marked as Seen',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
      },
