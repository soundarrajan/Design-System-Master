...
import { RowstatusOnchangePopupComponent } from 'src/app/shared/designsystem-v2/rowstatus-onchange-popup/rowstatus-onchange-popup.component';
...
tabChange(){
  ...
  private columnDef_aggrid = [
   {
      headerName: 'Order No.', headerTooltip: 'Order No.', field: 'orderNo',
      cellClass: ['aggridlink'],width:120,cellStyle: { 'padding-left': '15px' }
    },
    {
      headerName: 'Delivery No.', headerTooltip: 'Delivery No.', field: 'deliveryNo', 
      cellClass: ['aggridlink'], width:120
    },
    {
      headerName: 'Claim No. ', headerTooltip: 'Claim No. ', field: 'claimNo', 
      cellClass: ['aggridlink'], width:120
    },
    {
    ...
    {
      headerName: 'Sub-type', headerTooltip: 'Sub-type', field: 'subType',  width:120
    },
    ...
    { headerName: 'No Response', headerClass: ['aggrid-text-align-c'],cellClass: ['status aggridtextalign-center'],headerTooltip: 'Progress', field: 'status',width:150,
  ...
  public rowData_aggrid = [
    ...
    seller:'Repsol Petroleo',subType:'Demsity @ 15C',status:'New',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
    },
    { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
    seller:'Repsol Petroleo',subType:'Demsity @ 15C',status:'7-14 days',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
    },
    { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
    seller:'Repsol Petroleo',subType:'Demsity @ 15C',status:'New',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
    },
    ...
    { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
    seller:'Repsol Petroleo',subType:'Demsity @ 15C',status:'15+ days',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
    },
    { orderNo:'109661',deliveryNo:'12502',claimNo:'CLM1466',vessel:'Alabama',port:'Algeciras',product:'RMG 380 0.5%',
    seller:'Repsol Petroleo',subType:'Demsity @ 15C',status:'7-14 days',amount:'1035.15 USD',date:'Wed 17/03/21 05:30',createdBy:'mathangi',actions:''
    },
