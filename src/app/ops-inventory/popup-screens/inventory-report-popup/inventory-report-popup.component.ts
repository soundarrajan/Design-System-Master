...
export class InventoryReportPopupComponent implements OnInit {
    ...
    public columnDefs = [
        ...
        },
        {
            ...
            cellRendererParams: {
                type: 'hover-click-drag-menu-singleGrid', cellClass: ["aggridlink"], rowDetails: this.hoverRowDetails, headerLabel: "Tank-LongBeach",
                onClick: this.tankSummary.bind(this), cell_alignment: 'flex-end'
